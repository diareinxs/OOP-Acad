...
user may input(int, double, float, etc.), instruct the user to input any of the 4 fundamental operators: +,-,/, and *  otherwise display invalid message:/*
...
When the results in displayed, ask the user if he wants to do another calculation again: If Yes, procede with the First Step otherwise No end the vode.
